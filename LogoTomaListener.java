...
public interface LogoTomaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LogoTomaParser#name}.
	 * @param ctx the parse tree
	 */
	void enterName(LogoTomaParser.NameContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTomaParser#name}.
	 * @param ctx the parse tree
	 */
	void exitName(LogoTomaParser.NameContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link LogoTomaParser#deref}.
	 * @param ctx the parse tree
	 */
	void enterDeref(LogoTomaParser.DerefContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTomaParser#deref}.
	 * @param ctx the parse tree
	 */
	void exitDeref(LogoTomaParser.DerefContext ctx);
	/**
